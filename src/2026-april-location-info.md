---
layout: layout
title: "{dev.talk} - April 2026"
description: "Event details for {dev.talk} April 2026 - The One with Geospatial Clues and Post-Incident Truths"
...
<a id="floating-venue" href="#venue">
  📍 Room K101, Kimmeridge House | Wed 29th April @ 7:00 PM.</br>
   <b>Click for details.</b>
</a>
{% endif %}

## {dev.talk} - The One with Geospatial Clues and Post-Incident Truths

Hi there,

{{ eventOverview(16, events.all) }}
...
{{ speakerSession(35, sessions.allEvents) }}

---

{{ speakerSession(34, sessions.allEvents) }}
