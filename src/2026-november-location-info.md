---
layout: layout
title: "{dev.talk} - November 2026"
description: "Event details for {dev.talk} November 2026 - {dev.talk} -The one where we are all a bit rusty after the holidays"
includeBlueskyPosts: true
hideNextEventBanner: true
hideMainLogo: false
templateEngineOverride: njk,md
permalink: 2026-november-location-info.html
