---
layout: layout
title: "{dev.talk} - December 2027"
description: "Event details for {dev.talk} December 2027 - The one where we celebrate together"
includeBlueskyPosts: true
hideNextEventBanner: true
hideMainLogo: false
templateEngineOverride: njk,md
permalink: 2027-december-location-info.html
showVenueSection: false
eventId: 36
---

{% from "event-overview.njk" import eventOverview %}
{% from "event-details.njk" import eventDate, eventTitle %}
...
{{ speakerSession(73, sessions.allEvents) }}

{{ speakerSession(74, sessions.allEvents) }}
